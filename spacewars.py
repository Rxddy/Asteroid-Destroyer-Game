...
class Menu:
    def __init__(self):
        ...
        self.colors = ["springgreen", "red", "pink", "yellow", "white"]
    ...
    def draw(self):
        ...
        # Draw title
        self.pen.goto(0, 150)
        self.pen.color("springgreen")
        self.pen.write("ASTEROID DESTROYER", align="center", font=("Arial", 30, "bold"))
        ...
        self.pen.goto(0, -200)
        self.pen.color("white")
        self.pen.write("Use UP/DOWN arrows to navigate", align="center", font=("Arial", 12, "normal"))
        self.pen.goto(0, -230)
        self.pen.write("Press ENTER to select", align="center", font=("Arial", 12, "normal"))
